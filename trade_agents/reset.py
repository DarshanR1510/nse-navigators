...
from trade_agents import strategies
...
def reset_traders():
    Account.get("warren").reset(strategies.warren_strategy)
    Account.get("george").reset(strategies.george_strategy)
    Account.get("ray").reset(strategies.ray_strategy)
    Account.get("cathie").reset(strategies.cathie_strategy)
